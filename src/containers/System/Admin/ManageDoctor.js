...
class ManageDoctor extends Component {
    ...
    handleChangeSelect = async (selectedOption) => {
        ...
        if (res && res.errCode === 0 && res.data && res.data.Markdown) {
            ...
            let addressClinic = '', nameClinic = '', note = '', paymentId = '', priceId = '', provinceId = '',clinicId='',
                selectedPayment = '', selectedPrice = '', selectedProvince = '',selectedSpecialty='',specialtyId='',selectedClinic='';
    ...
    render() {
        ...
        return (
            <div className='manage-doctor-container'>
                ...
                <div className='row'>
                    <div className='col-4 form-group'>
                        <lable><FormattedMessage id="admin.manage-doctor.specialty" /></lable>
                        <Select
                    ...
                    <div className='col-4 form-group'>
                        <lable><FormattedMessage id="admin.manage-doctor.select-clinic" /></lable>
                        <Select
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        getAllRequiredDoctorInfor: () => dispatch(action.getRequiredDoctorInfor()),
