                    ...
                    <div className='container'>
                        <div className='row'>
                            ...
                            <div className='col-3'>
                                ...
                                <select className="form-control" onChange={(event) => { this.onChangInput(event, 'gender') }} value={gender}>
                            ...
                            <div className='col-3'>
                                ...
                                <select className="form-control" onChange={(event) => { this.onChangInput(event, 'position') }} value={position}>
                            ...
                            <div className='col-3'>
                                ...
                                <select className="form-control" onChange={(event) => { this.onChangInput(event, 'role') }} value={role}>
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        editAUserUser: (data) => dispatch(action.editAUser(data)),
